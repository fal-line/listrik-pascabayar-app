        ...
        <div class="col-md-8">
            ...
            <div class="mt-4">
                <a href="/clientData">Kembali ke data client</a>
                    ...
                    <div class="card-header h4 py-3 mt-4"><strong>Riwayat Penggunaan Daya Pelanggan</strong></div>
                    <hr  class="mt-2">
                    <table class="table ">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach($usages as $usage)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{$usage->meter_akhir - $usage->meter_awal}} KwH</td>
                                ...
                                @if($cekEmpty == 0)
                                <tr>
                                    <td colspan="6" class="table-active align-middle">Belum ada data riwayat penggunaan</td>
                                </tr>
                                @endif
